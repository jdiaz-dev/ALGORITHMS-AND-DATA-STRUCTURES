...
//mi solucion al problema 1 del libro
...
function reverseSinglyLinkedList(list){
    ...
    let currentNode = list.head, counter = 0    

    while(currentNode){
        reverseList.insertAtBeginning(currentNode.data)
...
console.log(reverseSinglyLinkedList(lista))
