...
//buscamos un nodo mediante un indice
console.log(lista.getAt(3))

//insertamos un nodo en mediante un indice dado
console.log(lista.insertAt('zzzz',4))
lista

//eliminamos un nodo al inicio de la lista
console.log(lista.deleteFirstNode())
lista

//eliminamos un nodo del final de la lista(zzzz)
console.log(lista.deleteEndNode())
lista

//eliminamos un nodo de la lista mediante un indice
