...
/* ======================= MI SOLUCION AL EJERCICIO 2 ======================= */
function Kth_smallestElement(heap,times){
    let response 
...
var result = Kth_smallestElement(minHeap, 5)
result

//mi solución es ineficiente porque termina eliminando todos los elementos del heap original
minHeap
