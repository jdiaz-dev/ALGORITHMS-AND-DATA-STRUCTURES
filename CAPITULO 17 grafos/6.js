/* 
    **Topological Sort
        ...
        --el algoritmo de orden topológico utiliza es un DSF mas una pila
*/
...
DirectedGraph.prototype.topologicalSortUtil = function(vertex, visited, stack){
    visited[vertex] = true

    for(let item in this.edges[vertex]){
        if(visited[item] === undefined){//caso base
...
DirectedGraph.prototype.topologicalSort = function(){
    ...
    return stack
    /* 
        Complejidad de tiempo O(V + E) donde V: vertices, E: aristas
